...
export default function Home() {
  ...
  const featuredItems = [
    {
      ...
      description:
        "Beef patty, sea cheese, lettuce, tomato, pickles, and secret sauce.",
      price: "$16.00",
      image:
  ...
  return (
    <div style={{ backgroundColor: "#FBF8EB", minHeight: "100vh" }}>
          ...
          <div>
                ...
                <div className="relative flex items-center justify-center h-full min-h-[50vh] sm:min-h-[60vh] md:min-h-[70vh] lg:min-h-[80vh] p-6 sm:p-12">
                  <div className="text-center text-white max-w-4xl mx-auto z-10">
                    ...
                    >
                      ...
                      <button
                        onClick={() =>
                          (window.location.href = "tel:2075550149")
                        }
            ...
            >
              {/* <div className="text-center mb-8">
                <h2
                  className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-headline font-bold mb-2"
                  style={{ color: "#144663" }}
                >
                  A few of our favorites
                </h2>
                <p
                  className="text-sm sm:text-base px-4 sm:px-0"
                  style={{ color: "#144663", opacity: 0.6 }}
                >
              ...
              {/* Featured Items Grid */}
              {/* <div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 mt-10 mb-8 px-4 sm:px-0">
                {featuredItems.map((item, index) => (
                  <motion.div
                    ...
                    className="bg-[#FBF8EB] border border-[#f2ecd4] rounded-3xl p-4 sm:p-5"
                  >
                    <div className="flex flex-col sm:flex-row gap-4">
                      <img
                        src={item.image}
                        alt={item.name}
                        className="w-full sm:w-[140px] md:w-[160px] h-[200px] sm:h-[140px] md:h-[160px] rounded-2xl object-cover flex-shrink-0"
                      />
              ...
              {/* <div className="text-center mt-8 px-4 sm:px-0">
                <button
                  className="px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-medium text-sm sm:text-base transition-all hover:shadow-md"
                  style={{
                    backgroundColor: "white",
                    color: "#144663",
                    border: "2px solid #144663",
                  }}
                >
                  Explore our menu
                </button>
                                  ...
                                  <div className="text-right flex-shrink-0">
                                    ...
                                    {typeof item.price === "string" ? (
                                      ...
                                      <div className="text-right">
                                        <p className="whitespace-nowrap" style={{ color: "#144663" }}>
                                      ...
                                      <div className="text-right">
                                        {item.price.options.map((option, i) => {
                                          const [quantity, price] = option.split(' ');
                                          return (
                                            <p
                                              key={i}
              ...
              <div id="location" className="mt-20">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  >
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2851.6847391089!2d-68.61259!3d45.36215!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4ca5f5f5f5f5f5f5%3A0x5f5f5f5f5f5f5f5f!2s49%20Main%20St%2C%20Lincoln%2C%20ME%2004457!5e0!3m2!1sen!2sus!4v1234567890"
                      width="100%"
                      height="100%"
                    ...
                    <div className="absolute bottom-6 left-6 right-6">
                      <div className="backdrop-blur bg-white/80 rounded-2xl p-6 shadow-xl flex flex-col sm:flex-row items-center sm:justify-between gap-4">
                        ...
                        <button
                          onClick={() =>
                            window.open(
                              "https://maps.google.com/?q=49+Main+St+Lincoln+ME+04457",
                              "_blank"
                            )
                          }
                    ...
                    <div className="space-y-8">
                      ...
                      <div>
                        ...
                        <div className="space-y-2 font-headline text-lg">
                          ...
                          >
                            <span>Monday</span>
                            <span className="font-headline">Closed</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-4 mt-6">
                            <a
                              href="#"
                              className="font-headline text-base hover:opacity-70 transition-opacity"
                              style={{ color: "#144663" }}
                            >
                              Instagram
                            </a>
                            <span style={{ color: "#144663", opacity: 0.3 }}>
                              •
                            </span>
                            <a
                              href="#"
      ...
      {/* Simple Footer */}
      {/* <footer
        className="text-white py-12 px-6 mt-12"
        style={{ backgroundColor: "#144663" }}
      >
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <p className="font-headline font-bold text-2xl">MAINE</p>
          </div>
          ...
          <p className="text-sm opacity-70">© 2024 49Maine • Lincoln, Maine</p>
        </div>
      </footer> */}
    </div>
  );
